 ...
 class Staff
	{
	    ...
	    Staff ()
	   {
	      ...
	      staffList[0] = new Executive ("Hannah", "1 ferthorpe road ",
	         "0540-238754", "100-25-1290", 3000);

	      staffList[1] = new Employee ("Assante", "309 SuameTown",
	      ...
	      staffList[5] = new Volunteer ("Ransford", "453 Max Lane",
	         "555-7282");
	      staffList[6] = new Commission ("Eben", "Atta Wusu Avenue", 
	    		  "0559558426", "1234-5678", 6.25, (6.25*0.2));
	      staffList[7] = new Commission ("Vanessa", "1 Ampabame Street ", 
	    		  "0552222334", "1668-9226", 9.75, (9.75*0.2));
